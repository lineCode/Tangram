...
// begin Add by TangramTeam
void RenderFrameImpl::OnTangramMessage(std::wstring channel, std::wstring arg1,	std::wstring arg2) {
	blink::WebLocalFrame* web_local_frame_= GetWebFrame();
	if (web_local_frame_) {
		blink::Tangram* pTangram = (blink::Tangram*)web_local_frame_->GetTangram();
