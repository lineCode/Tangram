...
namespace TangramCommon {
	...
	public:
		...
		CString									m_strTempPath = _T("");
		CString 								m_strConfigDataFile = _T("");
		CString									m_strAppDataPath = _T("");
		CString									m_strCurrentAppID = _T("");
		CString									m_strProgramFilePath = _T("");
		CString									m_strTangramURLBase = _T("");
		CString									m_strAppCommonDocPath = _T("");
		CString									m_strAppCommonDocPath2 = _T("");
		CString									m_strAppCommonFormsPath = _T("");
		CString									m_strAppCommonFormsInfoPath = _T("");
		CString									m_strAppCommonFormsTemplatePath = _T("");
		CString									m_strAppFormsPath = _T("");
		CString									m_strAppFormsInfoPath = _T("");
		CString									m_strAppWPFObjsInfoPath = _T("");
		CString									m_strAppControlsInfoPath = _T("");
		CString									m_strAppFormsTemplatePath = _T("");
		CString									m_strAppCurrentFormTemplatePath = _T("");
		CString									m_strNodeSelectedText = _T("");
		CString									m_strDesignerTip1 = _T("");
		CString									m_strDesignerTip2 = _T("");
		CString									m_strDesignerXml = _T("");
		CString									m_strDesignerToolBarCaption = _T("");
		CString									m_strStartView = _T("");
		CString									m_strNewDocXml = _T("");
		CString									m_strStartXml = _T("");
		CString									m_strNtpXml = _T("");
		CString									m_strNtpDataXml = _T("");

		CString 								m_strConfigFile = _T("");
		CString									m_strWinAppConfigFile = _T("");
		CString									m_strDocFilters = _T("");
		CString									m_strDesignerInfo = _T("");
		CString									m_strTemplatePath = _T("");
		CString									m_strCurrentFrameID = _T("");
		CString									m_strDocTemplateStrs = _T("");
		CString									m_strDefaultTemplate = _T("");
		CString									m_strDefaultTemplate2 = _T("");
		CString									m_strCurrentDocTemplateXml = _T("");
		CString									m_strCurrentKey = _T("");
		CString									m_strWorkBenchStrs = _T("");
		CString									m_strStartupURL = _T("");
		CString									m_strStartupCLRObj = _T("");
		CString									m_strCurrentEclipsePagePath = _T("");
		CString									m_strLogFileFormatPath = _T("");
		CString									m_strDefaultXml = _T("");
		CString									m_strLibs = _T("");
	...
	public:
		...
		virtual void LaunchEx(CTangramImpl* pTangramImpl) {};
	};
		...
		OmniboxViewViewsProxy() {
			...
			if (hModule != nullptr) {
				...
				if (GetTangramImplFunction != NULL) {
					...
					TangramCommon::CTangramImpl* _pImpl =
						GetTangramImplFunction(&pTangram);
					if (_pImpl) {
